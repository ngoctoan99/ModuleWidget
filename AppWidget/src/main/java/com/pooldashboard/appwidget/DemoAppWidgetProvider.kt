...
import com.pooldashboard.appwidget.CustomRemoteViewsFactory.Companion.dataList
...
//            remoteView.setOnClickPendingIntent(R.id.ivPoolDashBoard, pendingIntent)
        ...
        private fun setViewData(views: RemoteViews , context: Context) {
            ...
            views.setOnClickPendingIntent(R.id.ivPoolDashBoard,createPendingIntentToOpenLink(context,Uri.parse("https://play.google.com/store/apps/details?id=com.pooldashboard"),"com.pooldashboard"))
            //            val entries = listOf(
//                BarEntry(1f, 10f),
//                BarEntry(2f, 15f),
//                BarEntry(3f, 8f),
